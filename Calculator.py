...
wind = Tk()
wind.title("calculator andut")
wind.geometry("300x300")

text = Entry(wind,font=("times new roman", 16))
...
btnziro = Button(frame4,text="0",width=9,height=3, command=lambda:addToText("0"))
btnziro.pack(side=LEFT)
